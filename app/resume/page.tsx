...
export default function ResumePage() {
  ...
  return (
    <div className="w-full max-w-[64rem] gap-4 flex flex-col items-start pt-4 text-white">
      ...
      {/* Title */}
      <div className="bg-[#100720]/80 border-2 border-[#00ffff] px-6 py-2 w-fit mb-6">
      ...
      <ContainerGlass>
        <div className="relative border-l-2 border-dashed border-[#00ffff]/50 pl-6 md:pl-8 py-4 ml-3 space-y-12">
          ...
          {timelineData.map((item, idx) => (
            <div key={idx} className="relative group">
              ...
              <div 
                className="absolute left-[calc(-1.5rem-9px)] md:left-[calc(-2rem-11px)] top-1.5 w-4 h-4 md:w-5 md:h-5 border-2 transition-transform duration-300 group-hover:scale-125 group-hover:animate-pulse"
                style={{ 
              ...
              {/* Year badge */}
              <div 
                className="text-[#100720] px-3 py-1 font-bold text-xs uppercase retro-font-display w-fit mb-2 shadow-[4px_4px_0px_rgba(0,0,0,0.5)] border-2 border-[#100720]"
              ...
              {/* Details card */}
              <div className="flex flex-col max-w-2xl bg-[#100720]/80 p-5 border-2 border-[#00ffff]/30 hover:border-[#ff00ff] hover:shadow-[0_0_15px_#ff00ff] transition-all duration-200">
                <h3 className="text-xl font-extrabold text-white tracking-wide uppercase retro-font-display">
                  {item.company}
                </h3>
                <h4 className="text-sm font-semibold text-[#00ffff] uppercase tracking-wider mt-1 retro-font-display">
                  {item.role}
                </h4>
